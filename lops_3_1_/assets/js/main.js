...
function textTrennen() {
    text_array = []
    for(let i = 0; i < text.length; i = i + 100) {
        text_array.push(text.slice(i, 100 + i ))
    } 

    for(let i = 0; i < text_array.length; i++) {
        text_array[i] = `${text_array[i]} - ${i+1} of ${text_array.length}`}
        return text_array
} 


textTrennen()
console.log(textTrennen());